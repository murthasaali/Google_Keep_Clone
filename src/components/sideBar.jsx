...
function SideBar() {
  return (
    <div className="md:w-72 md:h-3/4 w-full h-20 absolute z-[100] md:flex  justify-end items-center  md:left-0  md:top-20 bottom-0 ">
      <div className="md:w-[90%] w-full h-full rounded-lg bg-stone-100 bg-opacity-40 flex md:justify-center justify-evenly   gap-5 items-center md:flex-col flex-row">
        <button
